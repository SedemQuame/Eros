...
public class PasswordReset extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button resetPasswordBtn = findViewById(R.id.resetPasswordButton);
        ...
        mAuth.sendPasswordResetEmail(emailAddress).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(PasswordReset.this, "Password reset link sent to your email", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), UserLogin.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(PasswordReset.this, "Unable to send password reset link.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
